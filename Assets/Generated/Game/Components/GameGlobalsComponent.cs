...
public partial class GameContext {
    ...
    public GameEntity SetGlobals(UnityEngine.GameObject newShotPrefab) {
        if (hasGlobals) {
        ...
        entity.AddGlobals(newShotPrefab);
        return entity;
    }

    public void ReplaceGlobals(UnityEngine.GameObject newShotPrefab) {
        var entity = globalsEntity;
        if (entity == null) {
            entity = SetGlobals(newShotPrefab);
        } else {
            entity.ReplaceGlobals(newShotPrefab);
        }
    }
...
public partial class GameEntity {
    ...
    public void AddGlobals(UnityEngine.GameObject newShotPrefab) {
